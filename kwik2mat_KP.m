...
port_site_depth_Barung_A1x16 = importdata([datapath 'port_site_depth_Barung_A1x16.mat']);
A = importdata('indx_port_site.txt',',');
kwd_indx = cellfun(@str2num,A.textdata(:,1));
kwd_port = A.data; %this assumes that site column of .txt is actually a repeat of portID
